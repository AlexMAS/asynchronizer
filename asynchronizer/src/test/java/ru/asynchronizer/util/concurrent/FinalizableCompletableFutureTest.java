...
public class FinalizableCompletableFutureTest {
    ...
    public void shouldHandleCancellation() {
        ...
        FinalizableCompletableFuture<Object> future = new FinalizableCompletableFuture<>(onComplete);
    ...
    public void shouldHandleTimeouts() {
        ...
        AtomicBoolean completed = new AtomicBoolean(false);
        Runnable onComplete = () -> completed.set(true);
        FinalizableCompletableFuture<Object> neverCompleted = new FinalizableCompletableFuture<>(onComplete);
